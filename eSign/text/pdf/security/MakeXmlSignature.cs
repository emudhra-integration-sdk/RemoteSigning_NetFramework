...
namespace eSign.text.pdf.security
{
    ...
    public class MakeXmlSignature
    {
         ...
         */
        public static void SignXmlDSig(XmlSignatureAppearance sap, IExternalSignature externalSignature, System.Security.Cryptography.Xml.KeyInfoClause keyInfo) {
        ...
        public static void SignXmlDSig(XmlSignatureAppearance sap,
            ...
            SignXmlDSig(sap, externalSignature, new System.Security.Cryptography.Xml.KeyInfoX509Data(chain[0].GetEncoded()));
        }
        ...
        private static byte[] CalculateC14nByteRange(XmlDocument doc) {
            System.Security.Cryptography.Xml.XmlDsigC14NTransform c14nTransform = new System.Security.Cryptography.Xml.XmlDsigC14NTransform();
        ...
        private static void Sign(XmlElement signature, IXmlLocator xmlLocator, IExternalSignature externalSignature, 
                                 List<XmlElement> references, XmlElement dsObject, System.Security.Cryptography.Xml.KeyInfoClause keyInfo) {

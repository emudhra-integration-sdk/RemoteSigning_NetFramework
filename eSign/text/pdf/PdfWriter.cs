...
using System.util;
using eSign.text.log;
using eSign.text.pdf.events;
using eSign.text.pdf.interfaces;
using eSign.text.pdf.intern;
using eSign.text.pdf.collection;
using eSign.text.xml.xmp;
using eSign.xmp.options;
